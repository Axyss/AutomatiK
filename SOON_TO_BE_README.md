...
- **Rich Embeds**: Game metadata powered by the **IGDB API**.
<img src="docs/assets/embed.png" height=450 alt="Epic Games Logo" />


- **Minimal Permissions**: No need for admin rights nor privileged intents.
- **AI Fallback**: Resilient parsing LLMs when standard methods fail. _Currently supporting Google, Anthropic and OpenAI models._
